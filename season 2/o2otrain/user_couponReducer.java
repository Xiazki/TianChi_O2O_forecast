...
public class user_couponReducer  extends ReducerBase{
	  Record result;
	  @Override
...
//				}
		...
		result.setBigint("user_coupon_all_lq_train",Long.valueOf(received_cnt));
		result.setBigint("user_coupon_shang_xun_lq_train",Long.valueOf(shangzhongxia_xun_lq[0]));
		result.setBigint("user_coupon_zhong_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[1]));
		result.setBigint("user_coupon_xia_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[2]));
		result.setBigint("user_coupon_holiday_lq_train", Long.valueOf(holiday_lq));
		result.setBigint("user_coupon_workday_lq_train", Long.valueOf(workday_lq));
		//----------
		result.setBigint("user_coupon_all_xf_train",Long.valueOf(buy_cnt));
		result.setBigint("user_coupon_shang_xun_xf_train",Long.valueOf(shangzhongxia_xun_xf[0]));
		result.setBigint("user_coupon_zhong_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[1]) );
		result.setBigint("user_coupon_xia_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[2]));
		result.setBigint("user_coupon_holiday_xf_train", Long.valueOf(holiday_xf));
		result.setBigint("user_coupon_workday_xf_train", Long.valueOf(workday_xf));
		//--------------
		result.setBigint("user_coupon_all_lq_and_xf_train",Long.valueOf(received_buy_cnt));
		result.setDouble("user_coupon_avg_day_train", avg_di(avg_day));
		result.setDouble("user_coupon_lq_xf_zhuanhua_train", (double)received_buy_cnt/(received_cnt+1));
		result.setBigint("user_coupon_shang_xun_lq_xf_train",Long.valueOf(shangzhongxia_xun_lq_and_xf[0]));
		result.setBigint("user_coupon_zhong_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[1]) );
		result.setBigint("user_coupon_xia_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[2]));
		//----------------------
...
//		result.setBigint("user_lq_diff_coupon_num",Long.valueOf( coupon_list.size()));
		//----------------
		result.setDouble("user_coupon_lq_avg_dis_train", avg_dis(avg_lq_dis));
		result.setDouble("user_coupon_xf_avg_dis_train", avg_dis(avg_lq_dis));
		result.setDouble("user_coupon_lq_and_xf_avg_dis_train", avg_dis(avg_lq_dis));
		//--------------------------
...
//		result.setBigint("user_lq_max_coupon",Long.valueOf( get_max_list_coupon(coupon_list)));
		...
		result.setBigint("user_coupon_in15day_train",Long.valueOf(in15day));
		result.setDouble("user_coupon_in15_bili_train", (double)in15day/(received_cnt+1));
