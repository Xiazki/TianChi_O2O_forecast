...
public class merchant_discountReducer  extends ReducerBase{
	  Record result;
	  @Override
...
//				}
		...
		result.setBigint("merchant_discount_all_lq_train",Long.valueOf(received_cnt));
		result.setBigint("merchant_discount_shang_xun_lq_train",Long.valueOf(shangzhongxia_xun_lq[0]));
		result.setBigint("merchant_discount_zhong_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[1]) );
		result.setBigint("merchant_discount_xia_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[2]));
		result.setBigint("merchant_discount_holiday_lq_train", Long.valueOf(holiday_lq));
		result.setBigint("merchant_discount_workday_lq_train", Long.valueOf(workday_lq));
		//----------
		result.setBigint("merchant_discount_all_xf_train",Long.valueOf(buy_cnt));
		result.setBigint("merchant_discount_shang_xun_xf_train",Long.valueOf(shangzhongxia_xun_xf[0]));
		result.setBigint("merchant_discount_zhong_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[1]) );
		result.setBigint("merchant_discount_xia_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[2]));
		result.setBigint("merchant_discount_holiday_xf_train", Long.valueOf(holiday_xf));
		result.setBigint("merchant_discount_workday_xf_train", Long.valueOf(workday_xf));
		//--------------
		result.setBigint("merchant_discount_all_lq_and_xf_train",Long.valueOf(received_buy_cnt));
		result.setDouble("merchant_discount_avg_day_train", avg_di(avg_day));
		result.setDouble("merchant_discount_lq_xf_zhuanhua_train", (double)received_buy_cnt/(received_cnt+1));
		result.setBigint("merchant_discount_shang_xun_lq_xf_train",Long.valueOf(shangzhongxia_xun_lq_and_xf[0]));
		result.setBigint("merchant_discount_zhong_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[1]) );
		result.setBigint("merchant_discount_xia_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[2]));
		//----------------------

		result.setBigint("merchant_discount_lq_diff_user_num_train",Long.valueOf( user_list.size()));
...
//		result.setBigint("user_lq_diff_coupon_num",Long.valueOf( coupon_list.size()));
		//----------------new add
		result.setDouble("merchant_discount_lq_avg_dis_train", avg_dis(avg_lq_dis));
		result.setDouble("merchant_discount_xf_avg_dis_train", avg_dis(avg_xf_dis));
		result.setDouble("merchant_discount_lq_and_xf_avg_dis_train", avg_dis(avg_lq_and_xf_dis));
		//--------------------------
		result.setBigint("merchant_discount_lq_max_user_train",Long.valueOf( get_max_list(user_list)));
//		result.setBigint("user_lq_max_merchant",Long.valueOf( get_max_list(merchant_list)));
//		result.setBigint("user_lq_max_coupon",Long.valueOf( get_max_list_coupon(coupon_list)));
		//////////////////new 
		
		
		result.setBigint("merchant_discount_in15day_train",Long.valueOf(in15day));
		result.setDouble("merchant_discount_in15day_bili_train", (double)in15day/(received_cnt+1));
