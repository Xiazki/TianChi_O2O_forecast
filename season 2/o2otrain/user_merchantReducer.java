...
public class user_merchantReducer  extends ReducerBase{
	  Record result;
	  @Override
...
//				}
		...
		result.setBigint("user_merchant_all_lq_train",Long.valueOf(received_cnt));
		result.setBigint("user_merchant_shang_xun_lq_train",Long.valueOf(shangzhongxia_xun_lq[0]));
		result.setBigint("user_merchant_zhong_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[1]) );
		result.setBigint("user_merchant_xia_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[2]));
		result.setBigint("user_merchant_holiday_lq_train", Long.valueOf(holiday_lq));
		result.setBigint("user_merchant_workday_lq_train", Long.valueOf(workday_lq));
		//----------
		result.setBigint("user_merchant_all_xf_train",Long.valueOf(buy_cnt));
		result.setBigint("user_merchant_shang_xun_xf_train",Long.valueOf(shangzhongxia_xun_xf[0]));
		result.setBigint("user_merchant_zhong_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[1]) );
		result.setBigint("user_merchant_xia_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[2]));
		result.setBigint("user_merchant_holiday_xf_train", Long.valueOf(holiday_xf));
		result.setBigint("user_merchant_workday_xf_train", Long.valueOf(workday_xf));
		//--------------
		result.setBigint("user_merchant_all_lq_and_xf_train",Long.valueOf(received_buy_cnt));
		result.setDouble("user_merchant_avg_day_train", avg_di(avg_day));
		result.setDouble("user_merchant_lq_xf_zhuanhua_train", (double)received_buy_cnt/(received_cnt+1));
		result.setBigint("user_merchant_shang_xun_lq_xf_train",Long.valueOf(shangzhongxia_xun_lq_and_xf[0]));
		result.setBigint("user_merchant_zhong_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[1]) );
		result.setBigint("user_merchant_xia_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[2]));
		//----------------------

//		result.setBigint("user_lq_diff_merchant_num",Long.valueOf( merchant_list.size()));
		result.setBigint("user_merchant_lq_diff_coupon_num_train",Long.valueOf( coupon_list.size()));
		//----------------
		result.setDouble("user_merchant_lq_avg_dis_train", avg_dis(avg_lq_dis));
		result.setDouble("user_merchant_xf_avg_dis_train", avg_dis(avg_xf_dis));
		result.setDouble("user_merchant_lq_and_xf_avg_dis_train", avg_dis(avg_lq_and_xf_dis));
		//--------------------------
//		result.setBigint("user_lq_max_merchant",Long.valueOf( get_max_list(merchant_list)));
		result.setBigint("user_merchant_lq_max_coupon_train",Long.valueOf( get_max_list_coupon(coupon_list)));
		
		
		////////////new
		result.setDouble("user_merchant_lq_avg_discount_rate_float_train", avg_dis(avg_lq_discount_rate_float));
		result.setDouble("user_merchant_lq_avg_discount_first_float_train", avg_dis(avg_lq_discount_first_float));
		
		result.setDouble("user_merchant_xf_avg_discount_rate_float_train", avg_dis(avg_xf_discount_rate_float));
		result.setDouble("user_merchant_xf_avg_discount_first_float_train", avg_dis(avg_xf_discount_first_float));
		
		result.setBigint("user_merchant_lq_in15day_train",Long.valueOf(in15day));
		result.setDouble("user_merchant_lq_in15_bili_train", (double)in15day/(received_cnt+1));
