...
public class coupon_distanceReducer  extends ReducerBase{
	  Record result;
	  @Override
	...
	@Override
	  public void reduce(Record key, Iterator<Record> values, TaskContext context)
		...
		List<mycount> user_list_lq=new ArrayList<mycount>();//去商店的次数
...
//				avg_lq_dis.add(Double.valueOf(val.getString("distance")));
		...
		result.setString("discount_rate", key.getString("discount_rate"));
		result.setString("distance", key.getString("distance"));

		result.setBigint("coupon_distance_all_lq_train",Long.valueOf(received_cnt));
		result.setBigint("coupon_distance_shang_xun_lq_train",Long.valueOf(shangzhongxia_xun_lq[0]));
		result.setBigint("coupon_distance_zhong_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[1]) );
		result.setBigint("coupon_distance_xia_xun_lq_train", Long.valueOf(shangzhongxia_xun_lq[2]));
		result.setBigint("coupon_distance_holiday_lq_train", Long.valueOf(holiday_lq));
		result.setBigint("coupon_distance_workday_lq_train", Long.valueOf(workday_lq));
		//----------
		result.setBigint("coupon_distance_all_xf_train",Long.valueOf(buy_cnt));
		result.setBigint("coupon_distance_shang_xun_xf_train",Long.valueOf(shangzhongxia_xun_xf[0]));
		result.setBigint("coupon_distance_zhong_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[1]));
		result.setBigint("coupon_distance_xia_xun_xf_train", Long.valueOf(shangzhongxia_xun_xf[2]));
		result.setBigint("coupon_distance_holiday_xf_train", Long.valueOf(holiday_xf));
		result.setBigint("coupon_distance_workday_xf_train", Long.valueOf(workday_xf));
		//--------------
		result.setBigint("coupon_distance_all_lq_and_xf_train",Long.valueOf(received_buy_cnt));
		result.setDouble("coupon_distance_avg_day_train", avg_di(avg_day));
		result.setDouble("coupon_distance_lq_xf_zhuanhua_train", (double)received_buy_cnt/(received_cnt+1));
		result.setBigint("coupon_distance_shang_xun_lq_xf_train",Long.valueOf(shangzhongxia_xun_lq_and_xf[0]));
		result.setBigint("coupon_distance_zhong_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[1]));
		result.setBigint("coupon_distance_xia_xun_lq_xf_train", Long.valueOf(shangzhongxia_xun_lq_and_xf[2]));
		//----------------------
		result.setBigint("coupon_distance_lq_diff_user_num_train",Long.valueOf( user_list_lq.size()));
		result.setBigint("coupon_distance_lq_max_user_train",Long.valueOf( get_max_list(user_list_lq)));
		//-----------------------------
		result.setBigint("coupon_distance_xf_diff_user_num_train",Long.valueOf( user_list_xf.size()));
		result.setBigint("coupon_distance_xf_max_user_train",Long.valueOf( get_max_list(user_list_xf)));		
		//---------------------------
...
//		result.setBigint("merchant_distance_lq_max_coupon_train",Long.valueOf( get_max_list_coupon(coupon_list)));
		...
		///////////////new 
		result.setBigint("coupon_distance_in15day_train",Long.valueOf(in15day));
		result.setDouble("coupon_distance_in15day_bili_train", (double)in15day/(received_cnt+1));
